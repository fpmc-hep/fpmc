...
C * This example : single diffraction at the Tevatron
C----------------------------------------------------------------------- 
      PROGRAM DPECS
c---Common block
...
c---Setting the hard subprocess : 11500 is inclusive dijets
      IPROC=11500
...
c---Check FPMC Settings + Initialisations for consistency
      CALL HWCHEK
