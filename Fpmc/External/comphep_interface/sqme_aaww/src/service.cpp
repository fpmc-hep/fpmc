...
namespace anom_aaww {
  int gwidth = 0;
  double va[11] = { 3.162278E+02, 7.757350E-03, 4.717500E-01, 9.118760E+01, 0.000000E+00, 0.000000E+00, 0.000000E+00, 0.000000E+00, 0.000000E+00, 8.817324E-01, 8.040306E+01 };
  const int nin_ = 2;
  const int nout_ = 2;
  const int nprc_ = 1;
  const int nvar_ = 7;
  ...
  int pinf_(int nsub,int nprtcl,char* pname, double* pmass) {
    int n;
    char names[1][4][7] = { { "A", "A", "W+", "W-" } };
    int nvalue[1][4] = { { 0, 0, 10, 10 } };
  ...
  int vinf_(int numvar,char * name, double * val) {
    char names[11][10]={ "Sqrt(S)", "alfEMZ", "SW", "MZ", "DkappA", "LambA", "a0W", "aCW", "EE", "CW", "MW" };
