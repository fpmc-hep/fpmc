     ...
     &ylcut,hacutd,lacutd,Etmin,yclucut,propcut
      ...
      double precision k(2), kp(2), k1(2), k2(2), k3(2)
       ...
       sudatab="Data/ggsudatab.d"
        ...
        ss=14000.0**2
       ptmin=20.0
       CALL CHIDeGGInit(ss,ptmin,0.075d0,.5d0,.5d0,4,
     &                  0.002d0,0.02d0,0.002d0,0.02d0,-2.5d0,2.5d0)
       
c      ss=1960.0**2
c      ptmin=10.0
c      CALL CHIDeGGInit(ss,ptmin,0.15d0,.5d0,.5d0,4,
c    &                  0.03d0,0.08d0,0.0d0,1.0d0,-2.5d0,2.5d0)
