      subroutine CHIDeGG(sigma,k_, kp_, k1_, k2_,
     & k3_,b1_,b2_,a1_,a2_)
      implicit none
      integer it,ndo  
...
C     Gluon gluon MANDELSTAM variables
      ...
      tgg=-CHIDedot(k2,k2)*(b1+b2)/b1
      ugg=-CHIDedot(k2,k2)*(b1+b2)/b2
...
C     Transverse energy of the two jets
      Ejet1=sqrt(CHIDedotdiff(k1,k2,k1,k2)-mq**2)
      Ejet2=sqrt(CHIDedotdiff(k2,k3,k2,k3)-mq**2)
...
C     Cuts on alpha and beta ordered
      if(a1+a2.GT.hacutd.or.a1+a2.LT.lacutd)goto 999
      if(b1+b2.GT.hbcutd.or.b1+b2.LT.lbcutd)goto 999 
...
C   ============================================================================   C
       call CHIDeQQM1(sigmaM1,a1,a2,b1,b2,k1,k2,k3,k,kp) 
