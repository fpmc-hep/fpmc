      SUBROUTINE CALCULATEWJJ(MASS,WGT,PJ1,PJ2,PL,PNU)

      !PROGRAM GGWW
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
      DOUBLE PRECISION MASS ! CENTRAL STATE MASS
      DOUBLE PRECISION WGT
      DOUBLE PRECISION P(4,100),XM(100),PW(4),PJJ(4)
      DOUBLE PRECISION PJ1(4), PJ2(4), PL(4), PNU(4)
      COMMON/AA/W,RMW,GSSQ,GWSQ
      COMMON/MOM/PLAB(4,8)
...
CC       RMUSQMAX=(RMW+DELTA)**2
CC       RMUSQMIN=(RMW-DELTA)**2
      RMUSQMAX=(W-RMW)**2
      RMUSQMIN=0D0
...
!      SUBROUTINE CUT(ICUT)
      ...
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
      DOUBLE PRECISION PSYS(4),AM(100),PS(4,100),PL(4),PC(4),P(4,100)
...
C
      ...
      DOUBLE PRECISION PBOO(4),PCM(4),PLB(4),Q,FACT
