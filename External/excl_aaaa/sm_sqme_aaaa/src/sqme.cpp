...
double sqme(double s, double t, double mW){
  ...
  me_SM(Mpppm_fermion,s,t,&re,&im,mW);
  value += 4*(re*re+im*im);
 
  me_SM(Mppmm_fermion,s,t,&re,&im,mW);
  value += re*re+im*im;

  me_SM(Mpppp_fermion,s,t,&re,&im,mW);
  value += re*re+im*im;

  me_SM(Mpmmp_fermion,s,t,&re,&im,mW);
  value += re*re+im*im;

  me_SM(Mpmpm_fermion,s,t,&re,&im,mW);
  value += re*re+im*im;
