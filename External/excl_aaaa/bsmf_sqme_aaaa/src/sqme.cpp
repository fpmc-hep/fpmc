...
*/
  ...
  Mpppp_fermion(sred,tred,&re_ex,&im_ex);
  ...
  Mppmm_fermion(sred,tred,&re_ex,&im_ex);
  re_ex *= 8*alpha_em*alpha_em*weight_exotic;
  im_ex *= 8*alpha_em*alpha_em*weight_exotic;
  ...
  Mpmmp_fermion(sred,tred,&re_ex,&im_ex);
  re_ex *= 8*alpha_em*alpha_em*weight_exotic;
  im_ex *= 8*alpha_em*alpha_em*weight_exotic;
  ...
  Mpmpm_fermion(sred,tred,&re_ex,&im_ex);
  re_ex *= 8*alpha_em*alpha_em*weight_exotic;
  im_ex *= 8*alpha_em*alpha_em*weight_exotic;
  ...
  Mpppm_fermion(sred,tred,&re_ex,&im_ex);
  re_ex *= 8*alpha_em*alpha_em*weight_exotic;
  im_ex *= 8*alpha_em*alpha_em*weight_exotic;
