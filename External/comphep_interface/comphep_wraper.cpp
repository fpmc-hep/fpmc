...
// // routines called by fpmc - note the difference masses of mw and mz 
  void sqme_aaww_c__(double *_amp2, double *_s, double *_t, double *_alpha, double* _mw, double *_sw, double *_dkappa, double *_lambda, double *_a0w, double *_aCw, double *_cutoff);
  void sqme_aaww_c_(double *_amp2, double *_s, double *_t, double *_alpha, double* _mw, double *_sw, double *_dkappa, double *_lambda, double *_a0w, double *_aCw, double *_cutoff);
  void sqme_aazz_c__(double *_amp2, double *_s, double *_t, double *_alpha, double* _mz, double *_sw, double *_a0z, double *_aCz, double *_cutoff);
  void sqme_aazz_c_(double *_amp2, double *_s, double *_t, double *_alpha, double* _mz, double *_sw, double *_a0z, double *_aCz, double *_cutoff);

  void sqme_aaaa_c__(double *_amp2, double *_s, double *_t, double *_alpha, double* _mw, double *_sw, double *_dkappa, double *_lambda, double *_a1a, double *_a2a, double *_cutoff);
  void sqme_aaaa_c_(double *_amp2, double *_s, double *_t, double *_alpha, double* _mw, double *_sw, double *_dkappa, double *_lambda, double *_a1a, double *_a2a, double *_cutoff);
#ifdef __cplusplus
}
#endif
...
void sqme_aaww_c__(double *_amp2, double *_s, double *_t, double *_alpha, double* _mw, double *_sw, double *_dkappa, double *_lambda, double *_a0w, double *_aCw, double *_cutoff)
{
  sqme_aaww_c_(_amp2, _s, _t, _alpha, _mw, _sw, _dkappa, _lambda, _a0w, _aCw, _cutoff);
}
...
void sqme_aazz_c__(double *_amp2, double *_s, double *_t, double *_alpha, double* _mz, double *_sw, double *_a0z, double *_aCz, double *_cutoff)
{
  sqme_aazz_c_(_amp2, _s, _t, _alpha, _mz, _sw, _a0z, _aCz, _cutoff);
}
...
//wrapper for g77
void
sqme_aaaa_c__(double *_amp2, double *_s, double *_t, double *_alpha, double* _mw, double *_sw, double *_dkappa, double *_lambda, double *_a1a, double *_a2a, double *_cutoff)
{
  sqme_aaaa_c_(_amp2, _s, _t, _alpha, _mw, _sw, _dkappa, _lambda, _a1a, _a2a, _cutoff);
}
