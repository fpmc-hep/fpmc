...
namespace anom_aazz {
  int gwidth=0;
  double va[8] = { 1.000000E+03, 7.757350E-03, 4.717500E-01, 9.118760E+01, 0.000000E+00, 0.000000E+00, 0.000000E+00, 8.817324E-01 };
  const int nin_ = 2;
  const int nout_ = 2;
  const int nprc_ = 1;
  const int nvar_ = 5;
  ...
  int pinf_(int nsub,int nprtcl,char* pname, double* pmass) {
    int n;
    char names[1][4][7]={ { "A", "A", "Z", "Z" } };
    int nvalue[1][4]={ { 0, 0, 3, 3 } };
  ...
  int vinf_(int numvar,char * name, double * val) {
    char names[8][10] = { "Sqrt(S)", "alfEMZ", "SW", "MZ", "a0Z", "aCZ", "EE", "CW" };
